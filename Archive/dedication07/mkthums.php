<?php
  ...
  if($pass == 2) {
    ...
    while(($file = readdir($id)) != false) {
      ...
      if(eregi("\.jpg", $file)) {
        fputs($fd, "<tr><td><a href=\"$file\"><img src=\"small-$file\" alt=\"$ar[$file]\"></a></td><td>");
        if($ar[$file] != "")
  ...
  while(($file = readdir($id)) != false) {
    ...
    if(eregi("\.jpg", $file))
      print(
"<tr><td><img src=\"mkjpgtnail.php?jpegImg=$file&dir=$dir&scale=4\" width=1 height=1>
<img src=\"small-$file\" alt=\"$file\"></td>
