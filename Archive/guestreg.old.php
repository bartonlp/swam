...
Your email address is required to register <br>
Remember, if you ask a question in the "Feedback" box below<br>
you will only get a reply if you give us your email address!</TD>
...
<TD><input type="text" name="bday" size=12 value="<?php echo "$bday"?>"></TD>
</TR>
<tr><td>Your URL address is <?php echo "$SwamUrl"?></td>
</tr>
<TR>
